---
template: Week 1 blueprint self-check
week: 1
---

# Eight-point self-check

Run this before you commit. Every answer must be yes.

1. Does every stage duration in section 1 come from the CSV rather than an estimate?
...
If any answer is no, fix it before committing. A blueprint with an unnamed gate
owner is the exact failure this week exists to prevent.
